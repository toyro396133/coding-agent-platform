...
- Modify: pp/settings/page.tsx

**Interfaces:**
- Consumes: existing settings page tab structure
- Consumes: sessionAtom from @/lib/atoms/session
- Consumes: GET /api/auth/admin/users and POST /api/auth/admin/users APIs
...
Add a new TabsTrigger after the existing ones:
`	ypescript
<TabsTrigger value="users">Users</TabsTrigger>
`

Add a new TabsContent after the existing ones:
`	ypescript
